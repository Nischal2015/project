...
<head>
    ...
    <meta content="Displays all departments" name="description">
    ...
    <main class="mt-1 p-2" style="min-height:800px">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-1 card mb-4">
                        <div class="card-header pb-2"><strong>Add Department</strong></div>
                        <div class="card-body">
                            <form action="<?php $_SERVER['REQUEST_URI']; ?>" method="post">
                                <div class="row">
                                    <div class="col-md-6 pt-2">
                                        <div class="form-floating mb-2"><input class="form-control" id="depname"
                                                name="depname" placeholder="Department"> <label
                                                for="depname">Department</label></div>
                                    </div>
                                    <div class="col-md-12"><button class="btn btn-primary" type="submit">Add</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-1 card mb-4">
                        <div class="card-header pb-2 py-3"><strong>Department List</strong></div>
                        <div class="card-body">
