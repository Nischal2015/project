                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a role="button" href="studentdetails.php?id='. e($row['student_id']) .'" class="information btn btn-primary btn-sm" id='. e($row['student_id']) .' title="Details" style="padding: 4px 5px !important;">	
