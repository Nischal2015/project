        ...
        <?php
            if($_SERVER['REQUEST_METHOD']=='POST') {
                ...
                if (isset($_POST['committee_assigned_id'])) {
                    ...
                    $par9 = mysqli_real_escape_string($conn, $_POST['originality']);
                    $par10 = mysqli_real_escape_string($conn, $_POST['consugrec']);
                ...
                if (isset($_POST['external_assigned_id'])) {
                    ...
                    $action=substr($identity, 0,2);
                    $sno = substr($identity,2);
                    $par1 = mysqli_real_escape_string($conn, $_POST['standard']); 
                    $par2 = mysqli_real_escape_string($conn, $_POST['research_identification']);
                    $par3 = mysqli_real_escape_string($conn, $_POST['research_methodology']);
                    $par4 = mysqli_real_escape_string($conn, $_POST['data_processing']);
                    $par5 = mysqli_real_escape_string($conn, $_POST['objectives']);
                    $par6 = mysqli_real_escape_string($conn, $_POST['logic_reason']);
                    $par7 = mysqli_real_escape_string($conn, $_POST['qua_abstract']);
                    $par8 = mysqli_real_escape_string($conn, $_POST['originality_research']);
                    $par9 = mysqli_real_escape_string($conn, $_POST['scope_research']);
                    $par10 = mysqli_real_escape_string($conn, $_POST['ans_examiner']);
                    $sum = $par1+$par2+$par3+$par4+$par5+$par6+$par7+$par8+$par9+$par10;
                    $portion = $sum / 100 * 20;
                    if($action=="ea") {
