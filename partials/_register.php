<form action="<?php $_SERVER['REQUEST_URI']; ?>" method="post">
    <div class="row">
        <div class="col-md-6 pt-4">
            <div class="form-floating mb-2"><input class="form-control" id="fname" name="fname" placeholder="Firstname">
                <label for="InputFirstname">Firstname</label></div>
        </div>
        <div class="col-md-6 pt-4">
            <div class="form-floating mb-2"><input class="form-control" id="lname" name="lname" placeholder="Lastname">
                <label for="InputLastname">Lastname</label></div>
        </div>
        <div class="col-md-6 pt-4">
            <div class="form-floating mb-2"><input class="form-control" id="roll" name="roll" placeholder="Roll No">
        ...
        <div class="col-md-6 pt-4">
            <div class="form-floating mb-2"><select aria-label="Default select example" class="form-select"
                    name="department" id="departmentadd">
                    <option selected>Choose..</option>
        ...
        <div class="col-md-6 pt-4">
            <div class="form-floating mb-2"><input class="form-control" id="year" name="year" placeholder="Thesis">
                <label for="year">Year</label></div>
        </div>
        <div class="col-md-6 pt-4">
            <div class="form-floating mb-2"><input class="form-control" id="thesis" name="thesis" placeholder="Thesis">
                <label for="thesis">Thesis Title</label></div>
        </div>
        <div class="col-md-6 pt-4">
            <div class="form-floating mb-2"><input class="form-control" id="regdate" name="regdate"
                    placeholder="Registration Date" type="date"> <label for="regdate">Registration Date</label></div>
        </div>
